            ...
            return (
              ...
              >
                ...
                <div className="flex flex-row justify-between items-center w-full border-t-[1px] p-4">
                  ...
                  <div className="border rounded-lg py-2 px-5 border-orange-400 text-orange-400 hover:bg-orange-400 hover:text-white cursor-pointer">
                    Detail
                  </div>
                </div>
              </div>
