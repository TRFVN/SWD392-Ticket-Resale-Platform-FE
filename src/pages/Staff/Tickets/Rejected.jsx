            ...
            return (
              ...
              >
                ...
                <div className="flex flex-row justify-between items-center w-full border-t-[1px] p-4">
                  ...
                  <div className="flex flex-row justify-center items-start gap-2 py-2 px-5 text-red-500 ">
                    <X /> Approved
                  </div>
                </div>
              </div>
