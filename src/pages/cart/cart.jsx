...
const CartItem = ({ ticket, onRemove }) => {
  return (
    <div className="flex flex-col sm:flex-row gap-4 p-4 bg-gray-800/50 backdrop-blur rounded-xl border border-gray-700">
      ...
      <div className="flex-1 flex flex-col justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">{ticket.eventName}</p>
        </div>
...
const CartSummary = ({ totalAmount, itemCount, onCheckout, isLoading }) => {
  return (
    <div className="bg-gray-800/50 backdrop-blur rounded-xl border border-gray-700 p-6 space-y-6">
...
const EmptyCart = () => (
  <div className="flex flex-col items-center justify-center min-h-[60vh] p-4">
    <div className="p-6 bg-gray-800/50 backdrop-blur rounded-full mb-6">
